...
import UIKit
class PastTest: UITableViewController {
    //init var
    ...
    override func viewDidLoad() {
        ...
        tableView.register(PastTestCell.self, forCellReuseIdentifier: "cellId")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let myCell = tableView.dequeueReusableCell(withIdentifier: "cellId", for: indexPath as IndexPath) as! PastTestCell
    ...
    func HTTPRequest_Get()->String {
        ...
        let url = NSURL(string: TargetServer+"QuizsApi/GetQuizPart?status=0&token=null&qid=null")
...
class PastTestCell: UITableViewCell {
    
    var myTableViewController: PastTest?
    ...
    func setupViews() {
        ...
        actionButton.addTarget(self, action: #selector(PastTestCell.handleAction), for: .touchUpInside)
